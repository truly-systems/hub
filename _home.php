            ...
            <section id="page-content">
                ...
                <footer class="footer-content">
                    <span id="tour-19">
                        ...
                        <?php echo date("Y"); ?> - <span id="copyright-year"></span> &copy; Truly. <?php echo __('Created by'); ?> <a href="http://www.trulysystems.com" target="_blank">Truly Systems</a>, TrulyManager
